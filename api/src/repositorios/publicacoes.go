...
func (repositorio Publicacoes) Criar(publicacao modelos.Publicacao) (uint64, error) {
	...
	ultimoIDInserid, erro := resultado.LastInsertId()
	if erro != nil {
		return 0, erro
	}

	return uint64(ultimoIDInserid), nil
}

// traz uma publicacao especifica
...
// traz publis dos usuarios seguidos e de si mesmo
